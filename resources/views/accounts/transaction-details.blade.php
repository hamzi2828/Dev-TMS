                        ...
                        <div class="col-md-12 col-12">
                            ...
                            <div class="card">
                                <div class="border-bottom-light card-header mb-2 pb-1 pb-1">
                                    <h4 class="card-title offset-2">{{ $title }}</h4>
                                </div>
                                <div class="card-body pt-0">
                                    @if($general_ledger && count($general_ledger -> transaction_details) > 0)
                                        <form class="form" method="post"
                                            ...
                                            <div class="row">
                                                <div class="form-group col-3 mb-1 offset-2">
                                            ...
                                            <hr />
                                            <button type="submit" class="btn btn-primary me-50 offset-2">
                                                Submit
                                            </button>
                                        </form>
                                    @endif
