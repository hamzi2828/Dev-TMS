        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <form class="pt-0" method="post" action="{{ route ('accounts.store') }}">
                        @csrf
                        <div class="card-body pt-1 pb-1">
                            <div class="row">
                                ...
                                <div class="col-3 mb-3">
                                    ...
                                    <select name="account-head-id" id="account-heads" class="form-control chosen-select"
                                ...
                                <div class="col-3 mb-3">
                                    ...
                                    <select name="account-type-id" id="account-type" class="form-control chosen-select"
                                            data-placeholder="Select">
                                        <option></option>
                                        @if(count ($types) > 0)
