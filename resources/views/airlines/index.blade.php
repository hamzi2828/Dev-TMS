<x-dashboard :title="$title">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        @can('delete', $airline)
                                            <form method="post" id="delete-record-form-{{ $airline -> id }}"
                                                  action="{{ route ('airlines.destroy', ['airline' => $airline -> id]) }}">
                                                @method('DELETE')
                                                @csrf
                                                <button type="button" data-bs-toggle="tooltip"
                                                        ...
                                                        onclick="delete_confirmation({{ $airline -> id }})">
    ...
    @push('scripts')
        <script type="text/javascript">
            init_datatable ( '{{ route ('airlines.create') }}' )
        </script>
    @endpush
</x-dashboard>