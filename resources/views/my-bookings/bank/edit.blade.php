<x-dashboard :title="$title">
    ...
    <div class="container-p-x flex-grow-1 container-p-y">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('myBookings.updateBank', $bank) }}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row justify-content-end">
                        <div class="col-sm-10">
                            ...
                            <a href="{{ route('myBookings.bankDetails') }}" class="btn btn-secondary">Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
