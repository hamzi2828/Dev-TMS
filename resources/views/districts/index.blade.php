<x-dashboard :title="$title">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        @can('edit', $district)
                                            <form method="post" id="delete-record-form-{{ $district -> id }}"
                                                  action="{{ route ('districts.destroy', ['district' => $district -> id]) }}">
                                                @method('DELETE')
                                                @csrf
                                                <button type="button" data-bs-toggle="tooltip"
                                                        ...
                                                        onclick="delete_confirmation({{ $district -> id }})">
    ...
    @push('scripts')
        <script type="text/javascript">
            init_datatable ( '{{ route ('districts.create') }}' )
        </script>
    @endpush
</x-dashboard>