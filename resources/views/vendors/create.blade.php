        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <form class="pt-0" method="post" action="{{ route ('vendors.store') }}"
                        ...
                        <div class="card-body pt-1 pb-1">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="number" class="form-control" value="{{ old ('fee') }}"
                                           id="fee" name="fee" />
                                </div>
                                
                                <div class="col-md-3 mb-3">
                                    <label class="form-label" for="vendor-payable">Vendor Payable</label>
                                    <input type="number" class="form-control" value="{{ old ('vendor-payable') }}"
