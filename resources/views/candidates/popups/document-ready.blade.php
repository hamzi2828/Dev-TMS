<div class="modal fade" id="candidateStatusModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered1 modal-simple">
        <div class="modal-content p-0">
            ...
            <form method="post" action="{{ route ('document-ready.bulk-status-update') }}">
                @csrf
                <div class="modal-body pt-3">
                    ...
                    <div class="col-12">
                        ...
                        <select name="status" class="form-control select2" data-placeholder="Select"
                                ...
                                id="status">
                            <option></option>
                            <option value="yes" @selected(old ('status') == 'yes')>Yes</option>
                            <option value="no" @selected(old ('status') == 'no')>No</option>
                            <option value="0" @selected(old ('status') == '0')>On Hold</option>
                        </select>
                    </div>
                </div>
