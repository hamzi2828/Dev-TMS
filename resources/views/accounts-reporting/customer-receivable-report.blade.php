<x-dashboard :title="$title">
    ...
    <div class="container-p-x flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="get" action="{{ route ('accounts-reporting.customer-receivable-report') }}">
                    <div class="row mt-4">
                        <div class="form-group offset-2 col-md-2 mb-1">
            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-end">
                    <a href="javascript:void(0)" onclick="downloadExcel('Customer Receivable')"
                       class="btn btn-sm btn-primary me-2 mb-1 btn-xs">
                        <i class="tf-icons ti ti-file-spreadsheet fs-6 me-1"></i>
                        Download Excel
                    </a>
                    <a href="{{ route ('invoices.customer-receivable-report', request () -> all ()) }}"
                       target="_blank"
                    ...
                    @if(count ($account_heads) > 0)
                        @foreach($account_heads as $account_head)
                            ...
                            <tr>
                                ...
                                <td>{{ $account_head -> candidate ?-> passport }}</td>
