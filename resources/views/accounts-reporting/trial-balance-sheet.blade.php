<x-dashboard :title="$title">
    ...
    <div class="container-p-x flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="get" action="{{ route ('accounts-reporting.trial-balance-sheet') }}">
                    <div class="row mt-4">
                        <div class="form-group col-md-3 offset-2 mb-1">
            ...
            @if(count ($account_heads) > 0)
                <div class="row">
                    <div class="col-12 d-flex justify-content-end">
                        <a href="javascript:void(0)" onclick="downloadExcel('Trial Balance Sheet')"
                           class="btn btn-sm btn-primary me-2 mb-1 btn-xs">
                            <i class="tf-icons ti ti-file-spreadsheet fs-6 me-1"></i>
                            Download Excel
                        </a>
                        <a href="{{ route ('invoices.trial-balance-sheet', request () -> all ()) }}"
                           target="_blank"
