<?php
    ...
    */
    ...
    define ( 'site_title', 'JMS HR Module' );
    define ( 'licenced', 'Sirius Technologies' );
    
    define ( 'site_email', 'info@jms.com' );
    define ( 'site_name', 'JMS HR Module' );
    define ( 'site_slug', 'JMS-HR' );
    define ( 'hospital_address', '<strong>Head Office:</strong> 62/A Meridian Mall, 2nd Floor, Above NADRA Executive
Passport Office , Satellite Town, Murree Road Rawalpindi' );
    define ( 'hospital_phone', '+9251 4932011' );
